...
TEST(InspireLauncherTest, RunPirUsesLauncherEntry) {
  const auto tmp_dir =
      std::filesystem::temp_directory_path() / "inspire_launcher";
  ...
  InspireSenderConfig sender_config;
  ...
  InspireReceiverConfig receiver_config;
